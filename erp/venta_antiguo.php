  ...
  <div class="content-wrapper" style="background-color:#FEFEEE;">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <!-- /.card-header -->
        <?php
        $sql = "SELECT `idventa`, `idusuario`, `idcliente`, `fecha_documento`, `tipo_documento`, `numero_documento`, `razon_social`, `forma_pago`, `numero_operacion`, `subtotal`, `igv`, `total`, `estado`, `fecha_hora_sistema` FROM `venta` ";
        $sql.= "Where idventa > 0 ";
