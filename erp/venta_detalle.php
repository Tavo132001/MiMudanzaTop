        ...
        <div class="card-body">
          <form name="frmDatos" action="venta_detalle.php" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <select class="form-control" name="idusuario">
                    ...
                    {	$selected = "";
                      if($row["idusuario"]==$idusuario) $selected = "selected";?>
                      <option value="<?php echo $row["idusuario"]?>" <?php echo $selected?>><?php echo $row["nombre"].' '.$row["apellido"]?></option><?php 
                    }?>
                  </select>
                </div>
                <div class="col-6">
                  ...
                  <select class="form-control" name="idcliente">
                    ...
                    while($row = mysqli_fetch_array($result))
                    {	$selected = "";
                      if($row["idcliente"]==$idcliente) $selected = "selected";?>
                      <option value="<?php echo $row["idcliente"]?>" <?php echo $selected?>><?php echo $row["nombre"]?></option><?php 
                    }?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-6">
                  <label for="fecha_documento">Fecha de documento YYYY-MM-DD (*):</label>
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                    </div>
                  <input type="text" class="form-control" name="fecha_documento" id="fecha_documento" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="<?php echo $fecha_documento ?>">
                  </div>
                  <!-- /.input group -->
                </div>
                <div class="col-6">
