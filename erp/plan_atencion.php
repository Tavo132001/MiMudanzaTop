  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Plan de atención de Órdenes de Servicio</h1>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-header">
          <div class="form-group">
            <div class="row">
              <div class="col-12">
                <h3 class="card-title">Lista de el plan de atención por orden de fecha</h3>
              </div>
            </div>
          </div>
        ...
        <?php
        $sql = "SELECT `idplan`, `fechaplan`, `nombre`, `tipo` FROM `plan_atencion`"; 
        $sql.= "ORDER BY fechaplan";
        //echo ($sql);
        $result=dbQuery($sql);
