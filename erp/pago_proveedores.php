        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a class="btn btn-block btn-primary" href="nuevo_pago_proveedor.php" style="width: 100px;">Nuevo Pago</a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h3 class="card-title">Lista de pagos a proveedores</h3>
        </div>
       
        <!-- /.card-header -->

        <?php
        $sql = "SELECT id_proveedor, nombre_proveedor, fecha_transaccion, concepto, monto, estado_pago, metodo_pago, fecha_vencimiento, fecha_sistema FROM pagos_proveedores ORDER BY fecha_sistema DESC";
        $result = dbQuery($sql);
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" href="editar_pago_proveedor.php?id=<?php echo $row["id_proveedor"]?>">
                    ...
                    <td class="text-center">
                        <a class="btn btn-danger btn-sm delete_btn" data-toggle="modal" data-target="#modal-delete" data-idregistro="<?php echo $row['id_proveedor']; ?>" >
