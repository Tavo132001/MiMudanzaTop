...
if ($idregistro) {
  $sql = "DELETE FROM servicio WHERE idservicio = '$idregistro' ";
  dbQuery($sql);
  $mensaje = "3";
}
//DEL FILTRO
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a class="btn btn-block btn-primary" href="servicio_detalle.php?sAccion=new" style="width: 100px;">  Nuevo  </a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
        ...
        <div class="card-header">
          <div class="form-group">
            <div class="row">
              <div class="col-12">
                <h3 class="card-title">Lista de todos los Servicios brindados por la empresa</h3>
              </div>
            </div>
          </div>
        ...
        <?php
        $sql = "SELECT p.`idservicio`, p.`idcategoria`, p.`nombre`, p.`descripcion`, p.`fecha_hora_sistema`"; 
        $sql.= "FROM `servicio` p , categoria_servicio c ";
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-info btn-sm" href="servicio_detalle.php?sAccion=edit&idservicio=<?php echo $row["idservicio"]?>">
                    ...
                    <td class="text-center">
                        <a class="btn btn-danger btn-sm delete_btn" data-toggle="modal" data-target="#modal-delete" data-idregistro="<?php echo $row['idservicio']; ?>" >
