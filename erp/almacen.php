...
if ($idregistro) {
  $sql = "DELETE FROM almacen WHERE idproductoa = '$idregistro' ";
  dbQuery($sql);
  $mensaje = "3";
}
?>
  ...
  <div class="content-wrapper" style="background-color:#FEFEEE;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inventario en Almacén</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a class="btn btn-block btn-primary" href="almacen_detalle.php?sAccion=new" style="width: 100px;">  Nuevo  </a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h3 class="card-title">Lista de productos en Almacén</h3>
        </div>
       
        <!-- /.card-header -->

        <?php
        $sql = "SELECT idproductoa, idproducto, cantidad, estado FROM almacen";
        $result = dbQuery($sql);
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a class="btn btn-info btn-sm" href="almacen_detalle.php?sAccion=edit&idproductoa=<?php echo $row["idproductoa"] ?>">
                        <i class="fas fa-pencil-alt"></i> Editar
                      </a>
                    </td>
                    <td class="text-center">
                      <a class="btn btn-danger btn-sm delete_btn" data-toggle="modal" data-target="#modal-delete" data-idregistro="<?php echo $row['idproductoa']; ?>">
